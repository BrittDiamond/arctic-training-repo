...
#Preapre the dataset for calculating medians
...
# Plot the escapemnt as a bar chart

```{r}
ggplot(median_esc, aes(Species, median_escapement)) + geom_col() + coord_flip()

```

#Now working on building a map

We're stasrting from daily escapement data again, and finding the unique locations at which escapement was measured
